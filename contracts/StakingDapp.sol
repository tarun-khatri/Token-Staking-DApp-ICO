...
contract StakingDapp is Ownable, ReentrancyGuard{
    ...
    function addPool(IERC20 _depositedToken, IERC20 _rewardToken, uint256 _apy, uint256 _lockDays) public onlyOwner{
    ...
    function deposit(uint _pid, uint256 _amount) public nonReentrant {
    ...
    function withdraw(uint _pid, uint _amount) public nonReentrant {
        ...
        require(user.lockUntil <= block.timestamp, "Lock is Actie!");
