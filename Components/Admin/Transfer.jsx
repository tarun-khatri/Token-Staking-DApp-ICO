...
const Transfer = ({
  poolDetails, transferToken, setLoader, address
}) => {
  ...
  return <div className="tab-pane fade" id="tab-4" role="tabpanel">
    <div className="row">
        ...
        <div className="profile">
          <div className="row">
            ...
            <InputField
              ...
              name="method1"
              disabled={true}
              value={`${poolDetails?.contractTokenBalance} ${poolDetails?.depositToken?.symbol || ''}`}
            />
