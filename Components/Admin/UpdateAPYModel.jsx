...
const UpdateAPYModel = ({
  ...
  return <div className="modal modal--auto fade" id="modal-apool" tabIndex={-1} aria-labelledby="modal-apool" aria-hidden="true">
      ...
      <div className="modal-content">
          <div className="modal__content">
              ...
              <div className="modal__form">
                    ...
                    <input type="text" id="amount2" name="amount2" className="apool__input" style={{
