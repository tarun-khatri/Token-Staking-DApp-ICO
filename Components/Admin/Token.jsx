  ...
  return <div className="col-12">
    <div className="invest invest--big">
      ...
      <div className="invest__group">
          <input type="text" id="partnerlink" name="partnerlink" className="form__input" defaultValue={`${ADDRESS_EXPLORER}${STAKING_DAPP}`}></input>
          <p className="invest__text">
                Stake token with us to get the best return
          </p>
