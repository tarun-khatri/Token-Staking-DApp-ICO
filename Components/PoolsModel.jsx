      ...
      <div className="modal-content">
        <div className="modal__content">
          ...
          <p className="modal__text">
            Welcome to Crypto King, stake your {selectedPool?.depositToken.name} token to earn reward.
          </p>
          <div className="modal__form">
              <PopUpInputField title={`Stake ${selectedPool?.depositToken.name} token`}
                placeholder="Amount"
              ...
              <div className="form__group">
                ...
                <ul className="form__radio">
                    <InputRatio
                      index={1}
                      value={`Your Deposited: ${selectedPool?.amount}
                    ...
                    <InputRatio
                      index={3}
                      value={`My Balance: ${selectedPool?.depositToken.balance.slice(0,8)}
                          ${selectedPool?.depositToken.symbol}
                      `}
                    />
                </ul>
