...
const Withdraw = ({
  setWithdrawPoolID, poolDetails
}) => {

  const poolArray = poolDetails?.poolInfoArray ?? [];


  return <div id="crypto" className="section">
                  ...
                  >
                    <div className="node">
                      ...
                      <span className="node__line">
                          <img src="img/dodgers/dots--line-orage.svg" alt=""/>
                      </span>
                      ...
                      <button className="node__btn"
                        ...
                        onClick={() => setWithdrawPoolID(index == 0 ? 0 : index == 1 ? 1 : index == 2 ? 2 : "")
                        }
                      >
                        Withdraw / Claim
                      </button>
