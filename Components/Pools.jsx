...
const Pools = ({
  setPoolID, poolDetails, setSelectedPool, setSelectedToken
}) => {
        ...
        <div className="row">
          <div className="col-12 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
            <div className="section__title">
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi perferendis eum dolores reiciendis!
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="row">
        {
          poolArray.map((pool, index) => (
            <div key={index}
              className={`col-12 ${index === 0 || index === 1 ? "col-md-6" : index === 2 ? "" : ""
                } col-lg-4 `}
            >
              <div className="apool">
                ...
                <ul className={`nav nav-tabs apool__tabs apool__tabs--${index == 0
                    ? "orange"
                    : index === 1
                      ? "green"
                      : index == 2
                ...
                <span className={`block-icon block-icon--${index == 0
                    ? "orange"
                    : index == 1
                      ? "green"
                      : index == 2
